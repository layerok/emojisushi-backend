...
oc.Module.register('cms.widget.pagelookup', function() {
    class PageLookupWidget extends oc.FoundationBase
    {
        ...
        show() {
            var data = {
                pagemanager_flag: true,
                pagemanager_title: this.config.includeTitle,
                pagemanager_single: this.config.singleMode,
