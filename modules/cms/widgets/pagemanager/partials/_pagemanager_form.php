<div id="<?= $this->getId('popup') ?>" class="pagefinder-popup">
    <?= Form::ajax($this->getEventHandler('onInsertReference'), [
        ...
        <input type="hidden" name="pagemanager_flag" value="1" />
        <input type="hidden" name="pagemanager_title" value="<?= $includeTitle ? 1 : 0 ?>" />
        <input type="hidden" name="pagemanager_single" value="<?= $singleMode ? 1 : 0 ?>" />
